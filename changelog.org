...
* [2026-05-17 Sun]
** Added
*** Capture template target startup sync
    - Files selected as capture template targets are now automatically marked to sync on startup
    - PR: https://github.com/200ok-ch/organice/pull/1120
** Fixed
