...
* [2026-05-17 Sun]
** Fixed
*** Capture templates targeting another file
    - Fixed capture templates with a =file= target so captures are saved even when the target file has not been opened yet
    - The target file is loaded before insertion and synced after the capture is added
