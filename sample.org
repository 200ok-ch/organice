...
Now, you see the title in "semantic editing mode". For example, you can visually select TODO states. If you want to edit the header as raw text, click the 'pencil' icon, again. The same will apply to selection - different metadata will not be visible in semantic editing mode so that you can focus on the actual text value.
...
1. Pen: Edit header title
   - To edit the header in raw text mode, click the pen icon, again in the opened drawer.
2. Pen in square: Edit header description
   - To edit the description in raw text mode, click the pen in square icon, again in the opened drawer.
