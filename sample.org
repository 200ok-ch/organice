...
* Syncing
organice pulls down your org files from Dropbox or Google Drive. Click the "Sign in" button in the upper right hand corner to sign in with either Dropbox or Google Drive and authenticate organice.
...
* Future plans
organice is currently pretty usable for simple tasks, but there's a lot more to do.

If you have an idea or feature request, or if you want to contribute to organice, check out the [[https://github.com/200ok-ch/organice][GitHub page]]. We also have a [[https://gitter.im/organice/Lobby?source=orgpage][Gitter chatroom]] if you want to chat!
...
*** WebDAV
*** Mega
*** Others? If there's one you'd like, [[https://github.com/200ok-ch/organice/issues/new][create an issue]]!
...
** Ability to Tweet a header directly from organice                    :joke:
