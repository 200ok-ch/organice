...
#+html: <p align="center"> <img src="public/organice-small.png"/> </p>
...
- In parallel, when there's time, work on the new one until there's
  feature parity with the old one from organice.
