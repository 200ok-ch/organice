...
In the [[file:WIKI.org::#faq_webdav][WebDAV]], you'll find lots more information regarding WebDAV:
...
Before starting work on organice, [[github.com/munen/][@munen]] (the original maintainer)
...
- organice continues to evolve independently with it's own feature
  set. For example, it has [[#faq_webdav][WebDAV]] support.
