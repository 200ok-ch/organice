...
org-2go lets you directly edit your org files online. It syncs with
...
org-2go supports a flexible mechanism for capturing using URL
...
** Development
org-2go is built with React and Redux. It was bootstrapped with [[https://github.com/facebook/create-react-app][Create
React App]].
...
Since org-2go is a front-end only application, it can easily be
...
Before starting work on org-2go, I did use Beorg and donated to it
...
- org-2go is FOSS which is very much in the spirit of Org whilst Beorg
  is proprietary
- org-2go is web based, so there is no lock-in to a specific device or
  OS
- Beorg currently has better offline support

** History

org-2go is a fork from [[https://github.com/DanielDe/org-web][org-web]]. We are extraordinarily grateful to
...
have org-2go be available to any browser to enable anyone on the go or
any non-Emacs user easy access to Org files. Also, DanielDe thinks of
org-web as [[https://github.com/DanielDe/org-web/issues/72][his pet project]] whereas org-2go has the full power of 200ok
llc behind it whilst building a strong self-sufficient community
around it.

Thank you for all, DanielDe!

To see how org-2go differs from org-web, please consult the [[file:changelog.org][changelog]]
