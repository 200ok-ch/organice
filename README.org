...
If you want to do something more complex, for example capturing a URL
and a title (for example within a bookmarklet to create a reading
list), this would be a good starting point:
