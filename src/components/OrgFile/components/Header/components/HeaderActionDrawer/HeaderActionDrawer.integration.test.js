...
describe('HeaderActionDrawer Integration Tests', () => {
  ...
  describe('User Interactions - Basic Clicks', () => {
    ...
    test('handles widen click when narrowed', () => {
      ...
      const widenContainer = container
    ...
    test('handles deadline click', () => {
      ...
      const deadlineContainer = container
        .querySelector('.fa-calendar-check.fas')
        .closest('.header-action-drawer__ff-click-catcher-container');
    ...
    test('handles scheduled click', () => {
      ...
      const scheduledContainer = container
        .querySelector('.fa-calendar-check.far')
        .closest('.header-action-drawer__ff-click-catcher-container');
    ...
    test('handles clock in click when no active clock', () => {
      ...
      const clockContainer = container
        .querySelector('.fa-hourglass-start')
        .closest('.header-action-drawer__ff-click-catcher-container');
    ...
    test('handles clock out click when has active clock', () => {
      ...
      const clockContainer = container
        .querySelector('.fa-hourglass-end')
        .closest('.header-action-drawer__ff-click-catcher-container');
      fireEvent.click(clockContainer);
    ...
    test('handles refile header click', () => {
      ...
      const refileContainer = container
        .querySelector('.fa-file-export')
        .closest('.header-action-drawer__ff-click-catcher-container');
    ...
    test('has correct titles for all buttons', () => {
      ...
      expect(
        container
          .querySelector('.fa-pencil-alt')
          .closest('.header-action-drawer__ff-click-catcher-container')
      ).toHaveAttribute('title', 'Edit header title');
      expect(
        container
          .querySelector('.fa-edit')
          .closest('.header-action-drawer__ff-click-catcher-container')
      ).toHaveAttribute('title', 'Edit header description');
      expect(
        container
          .querySelector('.fa-tags')
          .closest('.header-action-drawer__ff-click-catcher-container')
      ).toHaveAttribute('title', 'Modify tags');
      expect(
        container
          .querySelector('.fa-list')
          .closest('.header-action-drawer__ff-click-catcher-container')
      ).toHaveAttribute('title', 'Modify properties');
      expect(
        container
          .querySelector('.fa-compress')
          .closest('.header-action-drawer__ff-click-catcher-container')
